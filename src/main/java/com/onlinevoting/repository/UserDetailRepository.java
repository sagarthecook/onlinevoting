...
public interface UserDetailRepository extends JpaRepository<UserDetail, Long> {
    ...
    @Query("SELECT u FROM UserDetail u WHERE u.phoneNo = :phoneNo and u.isActive = true")
    List<UserDetail> findByPhoneNoAndIsActiveTrue(String phoneNo);

    @Query("SELECT u FROM UserDetail u WHERE u.emailId = :emailId and u.isActive = true")
    List<UserDetail> findByEmailAndIsActiveTrue(String emailId);
}
